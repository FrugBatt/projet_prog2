...
object GameScene extends Scene {
  ...
  def init() : Unit = {
    ...
    objects = Vector(spawner, world, Lava, mountain, forest, ogre, goblin, chicken1, chicken2, north_wall, west_wall, south_wall, king, soldier1, soldier2, soldier3, soldier4, selectionbox)
