...
class Ogre(context: Scene) extends Enemy[King](context,16, 2, () => new Resource("game/coin.png", 2, ResourceType.COIN),"game/ogre.png", 38, 23, Array(8,8,8,8,8), animationTime = 100L, hp_x_offset = 14, target_id = 1){
