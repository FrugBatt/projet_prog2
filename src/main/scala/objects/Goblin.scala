...
class Goblin(context: Scene) extends Enemy[Castle](context,10, 1, () => new Resource("game/coin.png", 2, ResourceType.COIN),"game/goblin.png", 16, 18, Array(5,8,8,8,8), animationTime = 100L, hp_x_offset = 3, target_id = 2){
